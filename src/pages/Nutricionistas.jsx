...
const Nutricionistas = () => {
  ...
  const API_URI = process.env.NODE_ENV === 'development' ? 'http://localhost:3000/api/professional/all' : 'Nothing here yet';
  ...
  useEffect(() => {
    const fetchProfessionals = async () => {
      try {
        ...
        toast.error('Something went wrong when we try to get the professionals information')
      }
    }
